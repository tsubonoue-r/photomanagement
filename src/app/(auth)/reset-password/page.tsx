    ...
    const validateToken = async () => {
      ...
      try {
        ...
        if (data.valid) {
          ...
          setError(data.error || '無効または期限切れのリセットリンクです');
        }
      } catch {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">無効なリセットリンク</h2>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">パスワードリセット完了</h2>
            <p className="text-gray-600 mb-6">
              パスワードがリセットされました。ログインページに移動します...
            </p>
            <Link
              href="/login"
              className="block w-full px-4 py-2 text-center text-white bg-blue-600 hover:bg-blue-700 rounded-md"
